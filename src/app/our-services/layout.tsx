...
export const metadata: Metadata = {
  ...
  description: 'Talentix offers career workshops and assemblies for UK schools and youth organisations. Help students prepare for their first job with interactive career sessions.',
  keywords: [
    'career workshops UK',
